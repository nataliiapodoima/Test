...
<div class="example-full">
  ...
  <h1 id="example-title" class="example-title">Files Uploader</h1>
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="onEditorFile">
          <div class="modal-body">
            <div class="form-group">
              <label for="name">Name:</label>
              <input type="text" class="form-control" required id="name2"  placeholder="Please enter a file name" v-model="editFile.name">
            </div>
